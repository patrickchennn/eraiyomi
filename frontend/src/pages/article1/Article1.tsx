...
const Article1 = () => {
  ...
  useLayoutEffect(() => {
    const titleArticleLocal = "article 1";
    ...
    return (
      <>
        ...
        <div className='px-3 py-5 gap-3 relative min-[335px]:grid min-[576px]:grid-cols-5 max-[576px]:px-1'>
          {/* other posts/content */}
          <OtherPosts style='p-5 border border-zinc-300 rounded-xl h-fit bg-[#F7F9FA] shadow-inner dark:bg-zinc-900 dark:border-stone-800 max-[576px]:hidden'/>
          ...
          <div className='border border-zinc-300 rounded-xl bg-[#F7F9FA] shadow-md col-span-3 dark:bg-[#050505] dark:border-stone-800 max-[1024px]:col-span-4 max-[576px]:col-span-full'>
            ...
            <main className='px-16 py-8 max-[1024px]:px-14 max-[576px]:px-8'>
              ...
              <div className='transition-all duration-250 ease-[linear]'>
                <ParagraphHeading headingType='h2' headingName='ABCD 1' headingRef={headingRef}/>
              ...
              <div className='transition-all duration-250 ease-[linear]'>
                <ParagraphHeading headingType='h3' headingName='ABCD 2' headingRef={headingRef}/>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Expedita nostrum, neque sapiente fugit laudantium officia deleniti magnam maxime quae ipsam.</p>
                <br />
              </div>
  
              <div className='transition-all duration-250 ease-[linear]'>
                <ParagraphHeading headingType='h4' headingName='ABCD 3' headingRef={headingRef}/>
              ...
              <div className='transition-all duration-250 ease-[linear]'>
                <ParagraphHeading headingType='h2' headingName='XYZ 1' headingRef={headingRef}/>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Expedita nostrum, neque sapiente fugit laudantium officia deleniti magnam maxime quae ipsam.</p>
                <br />
              </div>
              ...
              />
              <LikeArticle articleId={articleData._id} articleDataState={[articleData,setArticleData]}/>
